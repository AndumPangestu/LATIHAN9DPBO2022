class Hunian():
    def __init__(self, jenis, jml_penghuni=1, jml_kamar=1, luas_tanah=1, kapasitas_listrik=1):
        self.jenis = jenis
    ...
    def get_luas_tanah(self):
        return str(self.luas_tanah) + "meter persegi"

    def get_kapasitas_listrik(self):
        return str(self.kapasitas_listrik) + "KWH"
